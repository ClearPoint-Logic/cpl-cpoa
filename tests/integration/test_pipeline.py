...
SAFE = dict(
    ...
    runtime={"framework": "adk", "language": "python", "deployment_target": "cloud_run",
             "region": "us-central1", "service_account_or_identity": "sa-research@cpoa-demo-fixtures.iam.gserviceaccount.com"},
...
CRM_MISSING_OWNER = dict(
    ...
    runtime={"framework": "langchain", "language": "python", "deployment_target": "cloud_run",
             "region": "us-central1", "service_account_or_identity": "sa-salesops@cpoa-demo-fixtures.iam.gserviceaccount.com"},
...
HEALTHCARE = dict(
    ...
    runtime={"framework": "adk", "language": "python", "deployment_target": "cloud_run",
             "region": "us-central1", "service_account_or_identity": "sa-health@cpoa-demo-fixtures.iam.gserviceaccount.com"},
    models=[{"provider": "google", "model": "gemini-2.5-flash", "purpose": "reasoning", "criticality": "required"}],
...
BUDGET_RUNAWAY = dict(
    ...
    runtime={"framework": "adk", "language": "python", "deployment_target": "cloud_run",
             "region": "us-central1", "service_account_or_identity": "sa-research2@cpoa-demo-fixtures.iam.gserviceaccount.com"},
    models=[
...
PROMPT_INJECTED = dict(
    ...
    runtime={"framework": "custom", "language": "typescript", "deployment_target": "external",
             "region": "us-central1", "service_account_or_identity": "sa-ops@cpoa-demo-fixtures.iam.gserviceaccount.com"},
